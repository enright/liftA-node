...
let emitterTest = naea.thenArrow(naea.firstArrow(naea.node.eventEmitterArrow(myevents, 'fred')), (x) => console.log('done ', x));
...
let emitterTest2 = naea.thenArrow(naea.firstArrow(naea.node.eventPropertyEmitterArrow(myevents2, 'fred', 'bing', 'bang')), (x) => console.log('done ', x));
